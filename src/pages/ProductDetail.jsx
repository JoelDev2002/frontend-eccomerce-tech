...
const ProductDetail = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <Link to="/shop" className="text-gray-500 hover:text-primary-600 mb-8 inline-block">
                ← Volver a la tienda
            </Link>
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 bg-primary-600 hover:bg-primary-700 text-white font-bold py-4 px-8 rounded-xl transition-all shadow-lg hover:shadow-primary-500/40 flex items-center justify-center gap-2"
                            >
